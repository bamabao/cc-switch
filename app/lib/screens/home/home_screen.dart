...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int _alertCount = 0;
  int _remainingCheckins = 0; // 剩余待服用次数
  ...
  Future<void> _loadData() async {
    try {
      ...
      try {
        ...
        remaining = checkinResult['total_pending'] as int? ?? 0;
      } catch (_) {
        checkinItems = [];
        remaining = 0;
      }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!_loading && _medicationCount > 0) ...[
                        ...
                        Text(
                          '今日共 $_medicationCount 种药品、剩余 $_remainingCheckins 次待服用',
